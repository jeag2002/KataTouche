...
public class FileInputListener implements InputListenerInterface {
	...
	@Override
	public List<InputBean> getInformation(String date) throws BusinessListenerException {
		...
		try {
			...
			reader.close();
			 ...
			 throw new BusinessListenerException(
					 "Something happened while processing input listener " + index + " : " + nEx.getMessage());
		} catch (IOException ioEx) {
			 throw new BusinessListenerException(
					"Something happened while processing input listener " + index + " : " + ioEx.getMessage());
		}
	...
	public void init() throws InitListenerException {
		...
		try {
			...
			throw new InitListenerException(
					"Something happened while initialize input listener " + index + " : " + iISEex.getMessage());
		} catch (NullPointerException nullEx) {
			throw new InitListenerException(
					"Something happened while initialize input listener " + index + " : " + nullEx.getMessage());
		} catch (IOException ioEx) {
			throw new InitListenerException(
					"Something happened while initialize input listener " + index + " : " + ioEx.getMessage());
		}
	}
